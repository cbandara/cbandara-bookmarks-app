...
/* global $, store, api */
  ...
  const bookmarkList = (function(){
    ...
    function generateBookmarkElement(bookmark){
      ...
      let bookmarkRating = `<p>${bookmark.rating} Stars</p>`;
      let bookmarkURL = `<a href="${bookmark.url}" target="_blank" class="button">Bookmark Link</a>`;
      let bookmarkDelete = '<button class="bookmark-item-delete js-bookmark-delete">Delete</button>';
